					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">ECR Villa </h4>
							</div>

										<div class="col-md-12 img_popup">
											<img src="architecture/residences/ecr_villa/villa1.jpg" class="rounded mx-auto d-block modal_img" alt="">
											</div>
