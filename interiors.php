        ...
        <div class="container">
            <div class="row no-padding" style="margin-bottom:40px;margin-top:20px;">
                ...
                <div class="col-md-10">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-4 col-sm-6 cinemas project_thumb">
                                <div class="content">
                                    <a href="inter_nfdc.php" >
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-6 hospitality project_thumb">
                                <div class="content">
                                      <a href="#" >
                                        ...
                                        <div class="middle fadeIn-top">
                                              <div class="text">Abyssinian, Meena Tai</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
