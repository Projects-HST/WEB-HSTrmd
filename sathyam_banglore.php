								...
								<div class="row ">
									<div class="col-md-6 project_img ">
										...
										<div class="col-md-6 project_img ">
											<div class="gallery-img gallery">
												<a onclick="showmodal()">
													<img class="content-image" src="interiors/cinemas/sathyam_banglore/sathyambgl2.jpg">
													</a>
												</div>
											</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">Sathyam Banglore </h4>
							</div>

							<div class="col-md-12 img_popup">
								<img src="interiors/cinemas/sathyam_banglore/sathyambgl2.jpg" class="rounded mx-auto d-block modal_img" alt="">
								</div>
													<div class="col-md-12 img_popup">
														<img src="interiors/cinemas/sathyam_banglore/sathyambgl1.jpg" class="rounded mx-auto d-block modal_img" alt="">
														</div>
