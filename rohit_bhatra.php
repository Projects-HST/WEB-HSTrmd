					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">Rohit Bhatra </h4>
							</div>

										<div class="col-md-12 img_popup">
											<img src="architecture/residences/rohit_bhatra/rb1.jpg" class="rounded mx-auto d-block modal_img" alt="">
											</div>
