								...
								<div class="row ">
									...
									<div class="col-md-6 project_img ">
										...
										<div class="col-md-6 project_img ">
											<div class="gallery-img gallery">
												<a onclick="showmodal()">
													<img class="content-image" src="architecture/commercial/mrf/mrf_2.jpg">
													</a>
												</div>
											</div>
											<div class="col-md-6 project_img ">
												<div class="gallery-img gallery">
													<a onclick="showmodal()">
														<img class="content-image" src="architecture/commercial/mrf/mrf_3.jpg">
														</a>
													</div>
												</div>
												<div class="col-md-6 project_img ">
													<div class="gallery-img gallery">
														<a onclick="showmodal()">
															<img class="content-image" src="architecture/commercial/mrf/mrf_5.jpg">
															</a>
														</div>
													</div>
													<div class="col-md-6 project_img ">
														<div class="gallery-img gallery">
															<a onclick="showmodal()">
																<img class="content-image" src="architecture/commercial/mrf/mrf_4.jpg">
																</a>
															</div>
														</div>
										<div class="col-md-6 project_img ">
											<div class="gallery-img gallery">
												<a onclick="showmodal()">
													<img class="content-image" src="architecture/commercial/mrf/mrf_6.jpg">
													</a>
												</div>
											</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="col-md-12 img_popup">
								<img src="architecture/commercial/mrf/mrf_1.jpg" class="rounded mx-auto d-block modal_img" alt="">
								</div>
								<div class="col-md-12 img_popup">
										<img src="architecture/commercial/mrf/mrf_2.jpg" class="rounded mx-auto d-block modal_img" alt="">
									</div>
									<div class="col-md-12 img_popup">
											<img src="architecture/commercial/mrf/mrf_3.jpg" class="rounded mx-auto d-block modal_img" alt="">
										</div>
										<div class="col-md-12 img_popup">
												<img src="architecture/commercial/mrf/mrf_4.jpg" class="rounded mx-auto d-block modal_img" alt="">
											</div>
											<div class="col-md-12 img_popup">
													<img src="architecture/commercial/mrf/mrf_5.jpg" class="rounded mx-auto d-block modal_img" alt="">
												</div>
												<div class="col-md-12 img_popup">
														<img src="architecture/commercial/mrf/mrf_6.jpg" class="rounded mx-auto d-block modal_img" alt="">
													</div>
