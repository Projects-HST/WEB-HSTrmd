						...
						<div class="col-md-4">
							<h3 class="area-title text-capitalize  margin-20px-bottom font-weight-300 sm-width-100 xs-width-100"
                                  style="color: #646466;font-size: 30px;">
																	Club house in Residential complex  </h3>
							<br>
								<b>Type :</b>
								<p>Hospitality</p>
								<b>Size :</b>
								...
								<div class="row ">
									<div class="col-md-6 project_img ">
										<div class="gallery-img gallery">
											<a onclick="showmodal()">
												<img class="content-image" src="interiors/hospitality/club_house/Emami1.jpg">
												</a>
											</div>
										</div>
										<div class="col-md-6 project_img ">
											<div class="gallery-img gallery">
												<a onclick="showmodal()">
													<img class="content-image" src="interiors/hospitality/club_house/Emami2.jpg">
													</a>
												</div>
											</div>
											<div class="col-md-6 project_img ">
												...
												<div class="col-md-6 project_img ">
													<div class="gallery-img gallery">
														<a onclick="showmodal()">
															<img class="content-image" src="interiors/hospitality/club_house/Emami4.jpg">
															</a>
														</div>
													</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">Club house in Residential complex </h4>
							</div>

							<div class="col-md-12 img_popup">
								<img src="interiors/hospitality/club_house/Emami1.jpg" class="rounded mx-auto d-block modal_img" alt="">
							</div>
							<div class="col-md-12 img_popup">
								<img src="interiors/hospitality/club_house/Emami2.jpg" class="rounded mx-auto d-block modal_img" alt="">
							</div>
							<div class="col-md-12 img_popup">
								<img src="interiors/hospitality/club_house/Emami3.jpg" class="rounded mx-auto d-block modal_img" alt="">
							</div>
							<div class="col-md-12 img_popup">
								<img src="interiors/hospitality/club_house/Emami4.jpg" class="rounded mx-auto d-block modal_img" alt="">
							</div>
