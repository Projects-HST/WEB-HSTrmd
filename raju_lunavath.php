								...
								<div class="row ">
									<div class="col-md-6 project_img ">
										<div class="gallery-img gallery">
											<a onclick="showmodal()">
												<img class="content-image" src="architecture/residences/raju_lunavath/rl1.jpg">
												</a>
											</div>
										</div>
										<div class="col-md-6 project_img ">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">Raju Lunavath</h4>
							</div>

										<div class="col-md-12 img_popup">
											<img src="architecture/residences/raju_lunavath/rl1.jpg" class="rounded mx-auto d-block modal_img" alt="">
											</div>
											<div class="col-md-12 img_popup">
												<img src="architecture/residences/raju_lunavath/rl2.jpg" class="rounded mx-auto d-block modal_img" alt="">
												</div>
