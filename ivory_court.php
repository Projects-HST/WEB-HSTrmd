								...
								<div class="row ">
									<div class="col-md-6 project_img ">
										<div class="gallery-img gallery">
											<a onclick="showmodal()">
												<img class="content-image" src="architecture/condominiums/ivory_court/ic_1.jpg">
												</a>
											</div>
										</div>
										<div class="col-md-6 project_img ">
											...
											<div class="col-md-6 project_img ">
												<div class="gallery-img gallery">
													<a onclick="showmodal()">
														<img class="content-image" src="architecture/condominiums/ivory_court/ic_3.jpg">
														</a>
													</div>
												</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">Ivory Court</h4>
							</div>
							<div class="col-md-12 img_popup">
								<img src="architecture/condominiums/ivory_court/ic_1.jpg" class="rounded mx-auto d-block modal_img" alt="">
								</div>
								<div class="col-md-12 img_popup">
									<img src="architecture/condominiums/ivory_court/ic_2.jpg" class="rounded mx-auto d-block modal_img" alt="">
									</div>
									<div class="col-md-12 img_popup">
										<img src="architecture/condominiums/ivory_court/ic_3.jpg" class="rounded mx-auto d-block modal_img" alt="">
										</div>
