								...
								<div class="row ">
									<div class="col-md-6 project_img ">
										...
										<div class="col-md-6 project_img ">
											<div class="gallery-img gallery">
												<a onclick="showmodal()">
													<img class="content-image" src="interiors/corporate/ramco/ramco2.jpg">
													</a>
												</div>
											</div>
											<div class="col-md-6 project_img ">
												<div class="gallery-img gallery">
													<a onclick="showmodal()">
														<img class="content-image" src="interiors/corporate/ramco/ramco3.jpg">
														</a>
													</div>
												</div>
												<div class="col-md-6 project_img ">
													<div class="gallery-img gallery">
														<a onclick="showmodal()">
															<img class="content-image" src="interiors/corporate/ramco/ramco4.jpg">
															</a>
														</div>
													</div>
													<div class="col-md-6 project_img ">
														<div class="gallery-img gallery">
															<a onclick="showmodal()">
																<img class="content-image" src="interiors/corporate/ramco/ramco5.jpg">
																</a>
															</div>
														</div>
														<div class="col-md-6 project_img ">
															<div class="gallery-img gallery">
																<a onclick="showmodal()">
																	<img class="content-image" src="interiors/corporate/ramco/ramco6.jpg">
																	</a>
																</div>
															</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">Ramco Corporate Office</h4>
							</div>

							<div class="col-md-12 img_popup">
								<img src="interiors/corporate/ramco/ramco1.jpg" class="rounded mx-auto d-block modal_img" alt="">
							</div>
							<div class="col-md-12 img_popup">
								<img src="interiors/corporate/ramco/ramco2.jpg" class="rounded mx-auto d-block modal_img" alt="">
							</div>
							<div class="col-md-12 img_popup">
								<img src="interiors/corporate/ramco/ramco3.jpg" class="rounded mx-auto d-block modal_img" alt="">
							</div>
							<div class="col-md-12 img_popup">
								<img src="interiors/corporate/ramco/ramco4.jpg" class="rounded mx-auto d-block modal_img" alt="">
							</div>
							<div class="col-md-12 img_popup">
								<img src="interiors/corporate/ramco/ramco5.jpg" class="rounded mx-auto d-block modal_img" alt="">
							</div>
							<div class="col-md-12 img_popup">
								<img src="interiors/corporate/ramco/ramco6.jpg" class="rounded mx-auto d-block modal_img" alt="">
							</div>
