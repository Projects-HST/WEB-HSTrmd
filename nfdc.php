								...
								<div class="row ">
									<div class="col-md-6 project_img ">
										<div class="gallery-img gallery">
											<a onclick="showmodal()">
												<img class="content-image" src="architecture/institution/NFDC/nfdc1.jpg">
												</a>
											</div>
										</div>
										<div class="col-md-6 project_img ">
											<div class="gallery-img gallery">
												<a onclick="showmodal()">
													<img class="content-image" src="architecture/institution/NFDC/nfdc2.jpg">
													</a>
												</div>
											</div>
											<div class="col-md-6 project_img ">
												<div class="gallery-img gallery">
													<a onclick="showmodal()">
														<img class="content-image" src="architecture/institution/NFDC/nfdc3.jpg">
														</a>
													</div>
												</div>
												<div class="col-md-6 project_img ">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="col-md-12 img_popup">
								<img src="architecture/institution/NFDC/nfdc1.jpg" class="rounded mx-auto d-block modal_img" alt="">
								</div>
								<div class="col-md-12 img_popup">
									<img src="architecture/institution/NFDC/nfdc2.jpg" class="rounded mx-auto d-block modal_img" alt="">
									</div>
									<div class="col-md-12 img_popup">
										<img src="architecture/institution/NFDC/nfdc3.jpg" class="rounded mx-auto d-block modal_img" alt="">
										</div>
										<div class="col-md-12 img_popup">
											<img src="architecture/institution/NFDC/nfdc4.jpg" class="rounded mx-auto d-block modal_img" alt="">
											</div>
