    ...
    <body>
                        ...
                        <div class="navbar-collapse collapse" >
                            <ul id="accordion" class="nav navbar-nav navbar-right panel-group main_menu">
                                <li class="dropdown panel">
                                    <a href="index.php" class="">Home <i class="fa fa-angle-down"></i></a>
                                </li>
                                <li class="dropdown panel">
                                    <a href="aboutus.php" class="">About <i class="fa fa-angle-down"></i></a>
                                </li>
                                <li class="dropdown panel">
                                    <a href="projects.php" class="">Projects <i class="fa fa-angle-down"></i></a>
                                </li>
                                <li class="dropdown panel">
                                    <a href="contacts.php" class="">Contacts <i class="fa fa-angle-down"></i></a>
                                </li>
        ...
        <section id="slider" class="no-padding">
            <div id="owl-demo" class="owl-carousel owl-theme light-pagination square-pagination dark-pagination-without-next-prev-arrow main-slider">
                <!-- slider item -->
                <div class="item owl-bg-img" style="background-image:url('banner/banner_1.jpg');">
                    <div class="opacity-full bg-dark-gray"></div>
                    <div class="container full-screen position-relative">

                        <div class="slider-typography text-center">
                            <div class="slider-text-middle-main">
                                <img alt="" src="banner_logo.png" class="logo web_logo"  style=""/>
                              <span class="white-text text-small text-uppercase letter-spacing-10 menu_box">
                                <a href="architecture.php" class="center_menu">Architecture</a>
                                <a href="interiors.php" class="center_menu">Interiors</a>
                                <a href="aboutus.php" class="center_menu">About</a>
                                <a href="contacts.php" class="center_menu">Contact</a>
                              </span>
                            </div>
                        </div>
                    </div>
                ...
                <!-- end slider item -->
                <!-- slider item -->
                <div class="item owl-bg-img" style="background-image:url('banner/banner_4.jpg');">
                    <div class="opacity-full bg-dark-gray"></div>
                    <div class="container full-screen position-relative">
                        <div class="slider-typography text-center">
                          <div class="slider-text-middle-main">
                ...
                <!-- end slider item -->
                <!-- slider item -->
                <div class="item owl-bg-img" style="background-image:url('banner/banner_3.jpg');">
                    <div class="opacity-full bg-dark-gray"></div>
                    <div class="container full-screen position-relative">
                        <div class="slider-typography text-center">
                          <div class="slider-text-middle-main">
