                    ...
                    <div class="container">
                        <div class="row no-padding">
                            <div class="col-md-2">
                                ...
                                <div class="">
                                    ...
                                    <ul class="portfolio-filter nav nav-tabs">
                                      ...
                                      <li class=""><a href="#" id="residence">Condominiums</a></li>
                                      <li class=""><a href="#" id="res">Hospitality</a></li>
                                      <li class=""><a href="#" id="res">Industrial</a></li>
                                      <li class=""><a href="#" id="res">Institutional</a></li>
                            ...
                            <div class="col-md-10">
                              <div class="" id="">
                                <div class="row">
                                <div class="col-md-4 col-lg-4 col-sm-6 commercial">
                                  <div class="content">
                                     <a href="https://unsplash.com/photos/HkTMcmlMOUQ" target="_blank">
                                       <div class="content-overlay"></div>
                                       <img class="content-image" src="architecture/spi1.jpg">
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6 commercial">
                                  ...
                                  <div class="col-md-4 col-lg-4 col-sm-6 residence_img">
                                  <div class="content">
                                     <a href="https://unsplash.com/photos/HkTMcmlMOUQ" target="_blank">
                                       <div class="content-overlay"></div>
                                        <img class="content-image" src="architecture/spi1.jpg">
