								...
								<div class="row ">
									<div class="col-md-6 project_img ">
										...
										<div class="col-md-6 project_img ">
											<div class="gallery-img gallery">
												<a onclick="showmodal()">
													<img class="content-image" src="architecture/hospitality/vpr_convention_center/cc2.jpg">
													</a>
												</div>
											</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="col-md-12 img_popup">
								<img src="architecture/hospitality/vpr_convention_center/cc1.jpg" class="rounded mx-auto d-block modal_img" alt="">
								</div>
								<div class="col-md-12 img_popup">
									<img src="architecture/hospitality/vpr_convention_center/cc2.jpg" class="rounded mx-auto d-block modal_img" alt="">
									</div>
